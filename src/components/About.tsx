const About = () => {
  ...
  I’m <b>Jeenokanth</b>, a final-year CS student passionate about 
  <b> Python, AI, and Problem-Solving</b>. I enjoy creating projects with real-world impact.
</p>

<h3 className="mt-6 text-xl font-semibold text-slate-900">🎓 Education</h3>
<p className="text-slate-700">
  <b>B.Tech CSE</b> – Adhiyamaan College of Engineering (2022–2026) <br />

const About = () => {
  ...
  <div className="max-w-5xl mx-auto px-6 lg:px-12">
    ...
    <div className="mt-12">
      ...
      <ul className="text-slate-800 text-base space-y-2">
        <li>
    ...
    <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
      <div>
        ...
        <div className="text-sm text-slate-700 uppercase tracking-wide">Projects</div>
      </div>

      <div>
        <div className="text-3xl font-bold text-green-700">200+</div>
        <div className="text-sm text-slate-700 uppercase tracking-wide">Problems Solved</div>
      </div>

      <div>
        <div className="text-3xl font-bold text-purple-700">5+</div>
        <div className="text-sm text-slate-700 uppercase tracking-wide">Hackathons</div>
      </div>

      <div>
        <div className="text-3xl font-bold text-orange-700">10+</div>
        <div className="text-sm text-slate-700 uppercase tracking-wide">Certifications</div>
      </div>
    </div>

    {/* Soft Skills */}
    <p className="mt-12 text-slate-800 text-center">

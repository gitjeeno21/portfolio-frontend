...
const Hero = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
      <section id="home" className="relative min-h-screen flex items-center justify-center px-6 pt-28 lg:pt-32 z-10">
            ...
            <div className="flex-1 text-center lg:text-left space-y-8 max-w-2xl">
              ...
              <div className="relative mb-8 mt-4">
                <div className="flex items-center justify-center lg:justify-start gap-3 mb-3">
                  <span className="text-lg text-slate-600 font-medium">Hello, I'm a</span>
                </div>
                <div className="relative flex items-center justify-center lg:justify-start">
                  <div className="backdrop-blur-xl bg-white/30 border border-white/40 rounded-2xl px-6 py-3 shadow-lg hover:shadow-blue-500/20 transition-all duration-300">
                    <div className="flex items-center gap-3">
                      <div className={`p-2 rounded-lg bg-gradient-to-r ${roles[currentRole].color} border border-white/30 shadow-lg`}>
                        <CurrentIcon className="w-5 h-5 text-white" />
                      </div>
                      <span className={`text-xl font-semibold bg-gradient-to-r ${roles[currentRole].color} bg-clip-text text-transparent`}>
              ...
              <div className="relative mb-8">
                <h1 className="text-4xl lg:text-4xl font-bold bg-gradient-to-r from-slate-800 via-blue-700 to-indigo-800 bg-clip-text text-transparent relative leading-tight">
                  Jeenokanth G
              ...
              {/* Tagline / Description */}
              <div className="relative backdrop-blur-xl bg-white/25 rounded-2xl p-6 border border-white/40 shadow-lg hover:shadow-blue-500/10 transition-all duration-300 mb-8">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6">
                <a
                  ...
                  download
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-blue-600 text-white font-semibold shadow-lg hover:bg-blue-700 transition"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white border border-blue-200 text-blue-700 font-semibold shadow-lg hover:bg-blue-50 transition"
                >
                ...
                <div className="flex items-center gap-3 mt-4 lg:mt-0">
                  {socialLinks.map((link) => (
                    <a
                      ...
                      className={`inline-flex items-center justify-center w-10 h-10 rounded-full border border-slate-200 bg-white text-slate-700 shadow hover:scale-110 transition ${link.color}`}
                    >
